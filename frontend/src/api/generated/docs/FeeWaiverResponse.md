...
**chargeName** | **string** |  | [optional] [default to undefined]
**scope** | **string** |  | [optional] [default to undefined]
**referenceId** | **string** |  | [optional] [default to undefined]
**waiverPercentage** | **number** |  | [optional] [default to undefined]
...
```typescript
import { FeeWaiverResponse } from './api';

const instance: FeeWaiverResponse = {
    id,
    chargeDefinitionId,
    chargeName,
    scope,
