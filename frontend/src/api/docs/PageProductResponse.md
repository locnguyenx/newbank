...
**content** | [**Array&lt;ProductResponse&gt;**](ProductResponse.md) |  | [optional] [default to undefined]
...
```typescript
import { PageProductResponse } from '@openapitools/openapi-typescript-axios';

const instance: PageProductResponse = {
    totalElements,
    totalPages,
    numberOfElements,
    first,
