...
**content** | [**Array&lt;CustomerResponse&gt;**](CustomerResponse.md) |  | [optional] [default to undefined]
...
```typescript
import { PageCustomerResponse } from '@openapitools/openapi-typescript-axios';

const instance: PageCustomerResponse = {
    totalElements,
    totalPages,
    numberOfElements,
    first,
